				...
				<Flex py="5px">
					{isAdding ? (
						...
						<>
							...
							{!cards.length && <IconButton ml={1} icon={<RiDeleteColumn />} colorScheme="red" size="md" variant="ghost" onClick={() => editor.deleteColumn(title)} aria-label="delete this column" />}
						</>
					)}
				</Flex>
			</Box>
